...
export function PlayIcon({
  ...
  return (
    <IconPlayerPlayFilled size={size} color={color} strokeWidth={strokeWidth} />
  );
}
...
export function ShuffleIcon({
  ...
  return (
    <IconArrowsShuffle size={size} color={color} strokeWidth={strokeWidth} />
  );
}
...
export function HeartFilledIcon({
  ...
  return (
    <IconHeartFilled size={size} color={color} strokeWidth={strokeWidth} />
  );
}
...
export function BackIcon({
  ...
  return (
    <IconChevronLeft size={size} color={color} strokeWidth={strokeWidth} />
  );
}
...
export function PlaylistAddIcon({
  ...
  return (
    <IconPlaylistAdd size={size} color={color} strokeWidth={strokeWidth} />
  );
}
...
export function AlertIcon({
  ...
  return (
    <IconAlertTriangle size={size} color={color} strokeWidth={strokeWidth} />
  );
}
...
export function AdjustmentsIcon({
  ...
  return (
    <IconAdjustments size={size} color={color} strokeWidth={strokeWidth} />
  );
}
